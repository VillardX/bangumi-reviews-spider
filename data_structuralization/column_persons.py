...
persons_division = persons_division.drop_duplicates()#去重
#persons_division.to_excel('persons_division.xlsx',index = False)#输出
persons_division.to_csv('persons_division.csv',encoding = 'utf-8', index = False)#输出
