...
- e.g. 
    ...
    |id|comments|
    |-|-|
    |XXXX|'强大的音乐和无比细腻的文笔，终究只有一人能得到被选择的幸福是如此的苦涩又是如此的闪耀\|sstars9\|\|', '水平有限，不做评价。\|sstars99\|\|', '不想评价\|sstars9\|\|', '三十禁作品名不虚传\|sstars10\|\|']|

    遍历属性comments中的每个元素，根据分割符'|'分割元素，将响应的信息填入comments_tsukkomi：

    |id|评论编号|评论内容|个人评分|
    |-|-|-|-|
    |XXXX|1|强大的音乐和无比细腻的文笔，终究只有一人能得到被选择的幸福是如此的苦涩又是如此的闪耀|9|
    |XXXX|2|水平有限，不做评价。|99|
    |XXXX|3|不想评价|9|
    |XXXX|4|三十禁作品名不虚传|10|
