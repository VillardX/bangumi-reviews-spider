...
#total_brief.to_excel('total_brief.xlsx', index = False)#输出
total_brief.to_csv('total_brief.csv', encoding='utf-8',index = False)#输出
...
#total_tag.to_excel('total_tag.xlsx',index = False)#输出
total_tag.to_csv('total_tag.csv',encoding='utf-8', index = False)#输出
...
#total_rank.to_excel('total_rank.xlsx', index = False)#输出
total_rank.to_csv('total_rank.csv',encoding='utf-8', index = False)#输出
